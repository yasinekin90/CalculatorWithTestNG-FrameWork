...
public class TestBaseRapor {
        ...
        extentReports.setSystemInfo("Automation Engineer", "Yasin Ekin");
        extentHtmlReporter.config().setDocumentTitle("Verifying All Components");
        extentHtmlReporter.config().setReportName("CALCULATOR");
    }
